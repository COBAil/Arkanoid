...
class App:
    def __init__(self, bool_value):
        ...
        # choose the right size background image and get width and height
        ...
        else:  # predominantly for 2560x1440
        ...
        # base parameters of progress board
    ...
    def run(self):
        ...
        # display menu and get quantity of columns
        if self.flag_menu:
        ...
        while True:
            ...
            if self.BALL.top - self.BALL_RADIUS > self.HEIGHT:
                # display lose inscription
                pygame.mixer.music.stop()
                pygame.mixer.music.load(self.LOSE_SOUND)
                pygame.mixer.music.set_volume(0.3)
                pygame.mixer.music.play()
                App(None).display_end_inscription('You Lose!', self.score, self.WIDTH * (7 / 30), game_session_time)
            ...
            if hit_index != -1:
                ...
                if self.score == quantity_columns * self.ROW:
                    # display victory inscription
                    pygame.mixer.music.stop()
                    pygame.mixer.music.load(self.VICTORY_SOUND)
                    pygame.mixer.music.set_volume(0.6)
                    pygame.mixer.music.play()
                    App(None).display_end_inscription('You Win!', self.score, self.WIDTH * (4 / 15), game_session_time)
            ...
            # display progress board and inscriptions
            ...
            render_inscription_score = self.FONT_PROGRESS_BOARD.render(
                f'SCORE: {self.score}', True, self.WHITE, self.BLACK)
            ...
            render_inscription_time = self.FONT_PROGRESS_BOARD.render(
                f'TIME: {game_session_time}', True, self.WHITE, self.BLACK)
            self.SCREEN.blit(render_inscription_time, (self.WIDTH // 60, int(self.HEIGHT * (113 / 120))))

            render_inscription_fps = self.FONT_PROGRESS_BOARD.render(
                f'FPS: {int(self.CLOCK.get_fps())}', True, self.WHITE, self.BLACK)
            self.SCREEN.blit(render_inscription_fps, (self.WIDTH // 60, int(self.HEIGHT * (29 / 30))))
    ...
    def display_menu(self):
        ...
        # colors for rectangles and inscriptions
        ...
        while self.flag_menu:
            ...
            render_settings_inscription = self.FONT_SETTINGS.render('SETTINGS', True, white_settings)
            self.SCREEN.blit(render_settings_inscription, (int(self.WIDTH * (13 / 40)), int(self.HEIGHT * (59 / 80))))
    ...
    def display_settings(self, flag_settings):
        ...
        # get width of quantity of columns
        ...
        while flag_settings:
            ...
            render_inscription = self.FONT_INSCRIPTIONS_IN_SETTINGS.render('BACKGROUNDS', True, self.WHITE)
            ...
            render_inscription = self.FONT_NAMES_BACKGROUND_IMAGES.render(
                'SUNSET IN THE CITY', True, white_first_name)
            ...
            render_inscription = self.FONT_NAMES_BACKGROUND_IMAGES.render(
                'NIGHT IN THE FOREST', True, white_second_name)
            ...
            render_inscription = self.FONT_NAMES_BACKGROUND_IMAGES.render(
                'SUNRISE IN THE CITY', True, white_thirst_name)
            ...
            render_inscription = self.FONT_NAMES_BACKGROUND_IMAGES.render(
                'SPACE GALAXY', True, white_fourth_name)
            ...
            render_back = self.FONT_BACK.render('BACK', True, white_back)
            ...
            pygame.draw.rect(self.SCREEN, self.BLACK, (self.WIDTH // 5, int(self.HEIGHT * (11 / 48)),
                             ...
                             border_radius=self.WIDTH // 30)
            render_inscription = self.FONT_INSCRIPTIONS_IN_SETTINGS.render('QUANTITY OF COLUMNS', True, self.WHITE)
    ...
    def display_end_inscription(self, inscription, score, width, game_session_time):
        ...
        while True:
            ...
            # draw rectangles and display inscription
            ...
            render_score = self.FONT_VALUES_END_INSCRIPTION.render(f'SCORE: {score}', True, self.WHITE)
            self.SCREEN.blit(render_score, (int(width), int(self.HEIGHT * (17 / 40))))

            render_time = self.FONT_VALUES_END_INSCRIPTION.render(f'TIME: {game_session_time}', True, self.WHITE)
            ...
            render_restart_inscription = self.FONT_RESTART_INSCRIPTION.render('RESTART', True, white_restart)
            ...
            render_menu_inscription = self.FONT_EXIT_MENU.render('MENU', True, white_exit_menu)
